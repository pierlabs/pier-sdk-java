...
public class CampaignUpdate   {
  ...
  private List<PlanCampaignUpdate> planosCampanhas = new ArrayList<PlanCampaignUpdate>();

  
  /**
   * Campaign name
   **/
  public CampaignUpdate nome(String nome) {
    this.nome = nome;
    return this;
  }
   ...
   **/
  public CampaignUpdate idTipoCampanha(Long idTipoCampanha) {
   ...
   **/
  public CampaignUpdate planosCampanhas(List<PlanCampaignUpdate> planosCampanhas) {
    this.planosCampanhas = planosCampanhas;
    return this;
  }
  
  @ApiModelProperty(example = "null", value = "List with the plans of campaign")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.nome, campaignUpdate.nome) &&
        Objects.equals(this.idTipoCampanha, campaignUpdate.idTipoCampanha) &&
        Objects.equals(this.planosCampanhas, campaignUpdate.planosCampanhas);
  }

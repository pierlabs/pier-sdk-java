...
public class Base   {
   ...
   * IP do servidor
   **/
  public Base servidor(String servidor) {
   ...
   * Nome do usu\u00C3\u00A1rio
   **/
  public Base usuario(String usuario) {
   ...
   * Senha
   **/
  public Base senha(String senha) {
    this.senha = senha;
    return this;
  }
   ...
   * Nome da base
   **/
  public Base nomeBase(String nomeBase) {
   ...
   * senha Criptografada
   **/
  public Base senhaCriptografada(Boolean senhaCriptografada) {
   ...
   * Dom\u00C3\u00ADnio da base
   **/
  public Base domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   **/
  public Base nomeBaseControleAcesso(String nomeBaseControleAcesso) {
   ...
   **/
  public Base idEmissor(Long idEmissor) {
   ...
   **/
  public Base servidorControleAcesso(String servidorControleAcesso) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, base.id) &&
        Objects.equals(this.servidor, base.servidor) &&
        Objects.equals(this.usuario, base.usuario) &&
        Objects.equals(this.senha, base.senha) &&
        Objects.equals(this.nomeBase, base.nomeBase) &&
        Objects.equals(this.senhaCriptografada, base.senhaCriptografada) &&
        Objects.equals(this.domain, base.domain) &&
        Objects.equals(this.nomeBaseControleAcesso, base.nomeBaseControleAcesso) &&
        Objects.equals(this.idEmissor, base.idEmissor) &&
        Objects.equals(this.servidorControleAcesso, base.servidorControleAcesso);
  }

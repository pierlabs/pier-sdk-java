...
public class TaxasRefinanciamento   {
   ...
   * ID das taxas
   **/
  public TaxasRefinanciamento id(Long id) {
    this.id = id;
    return this;
  }
   ...
   * ID da conta
   **/
  public TaxasRefinanciamento idConta(Long idConta) {
   ...
   * ID do produto
   **/
  public TaxasRefinanciamento idProduto(Long idProduto) {
   ...
   **/
  public TaxasRefinanciamento idPlanoConta(Long idPlanoConta) {
   ...
   * ID do plano PCT
   **/
  public TaxasRefinanciamento idPlanoPct(Long idPlanoPct) {
   ...
   **/
  public TaxasRefinanciamento idPlanoCreditoTaxa(Long idPlanoCreditoTaxa) {
   ...
   * Data de entrada
   **/
  public TaxasRefinanciamento dataEntrada(String dataEntrada) {
   ...
   **/
  public TaxasRefinanciamento vencimento(String vencimento) {
   ...
   **/
  public TaxasRefinanciamento recuperacaoEncargosFinanceiros(BigDecimal recuperacaoEncargosFinanceiros) {
   ...
   **/
  public TaxasRefinanciamento comissaoGarantia(BigDecimal comissaoGarantia) {
   ...
   **/
  public TaxasRefinanciamento agenciamento(BigDecimal agenciamento) {
   ...
   **/
  public TaxasRefinanciamento taxaMaximaProximoPeriodo(BigDecimal taxaMaximaProximoPeriodo) {
   ...
   **/
  public TaxasRefinanciamento taxaEncargosFinanciamento(BigDecimal taxaEncargosFinanciamento) {
   ...
   **/
  public TaxasRefinanciamento taxaMaximaSaque(BigDecimal taxaMaximaSaque) {
   ...
   * Taxa de saque
   **/
  public TaxasRefinanciamento taxaSaque(BigDecimal taxaSaque) {
   ...
   **/
  public TaxasRefinanciamento taxaMaximaCompraJuros(BigDecimal taxaMaximaCompraJuros) {
   ...
   **/
  public TaxasRefinanciamento taxaCompraJuros(BigDecimal taxaCompraJuros) {
   ...
   * Taxa de permanencia
   **/
  public TaxasRefinanciamento taxaPermanencia(BigDecimal taxaPermanencia) {
   ...
   * Taxa de permanencia
   **/
  public TaxasRefinanciamento taxaRefinanciamento(BigDecimal taxaRefinanciamento) {
   ...
   * Taxa de permanencia
   **/
  public TaxasRefinanciamento taxaRecuperacaoRefinanciamento(BigDecimal taxaRecuperacaoRefinanciamento) {
   ...
   **/
  public TaxasRefinanciamento taxaPercCalcPagamentoMinimo(BigDecimal taxaPercCalcPagamentoMinimo) {
   ...
   **/
  public TaxasRefinanciamento planoTaxaDefault(Integer planoTaxaDefault) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TaxasRefinanciamento taxasRefinanciamento = (TaxasRefinanciamento) o;
    return Objects.equals(this.id, taxasRefinanciamento.id) &&
        Objects.equals(this.idConta, taxasRefinanciamento.idConta) &&
        Objects.equals(this.idProduto, taxasRefinanciamento.idProduto) &&
        Objects.equals(this.idPlanoConta, taxasRefinanciamento.idPlanoConta) &&
        Objects.equals(this.idPlanoPct, taxasRefinanciamento.idPlanoPct) &&
        Objects.equals(this.idPlanoCreditoTaxa, taxasRefinanciamento.idPlanoCreditoTaxa) &&
        Objects.equals(this.dataEntrada, taxasRefinanciamento.dataEntrada) &&
        Objects.equals(this.vencimento, taxasRefinanciamento.vencimento) &&
        Objects.equals(this.recuperacaoEncargosFinanceiros, taxasRefinanciamento.recuperacaoEncargosFinanceiros) &&
        Objects.equals(this.comissaoGarantia, taxasRefinanciamento.comissaoGarantia) &&
        Objects.equals(this.agenciamento, taxasRefinanciamento.agenciamento) &&
        Objects.equals(this.taxaMaximaProximoPeriodo, taxasRefinanciamento.taxaMaximaProximoPeriodo) &&
        Objects.equals(this.taxaEncargosFinanciamento, taxasRefinanciamento.taxaEncargosFinanciamento) &&
        Objects.equals(this.taxaMaximaSaque, taxasRefinanciamento.taxaMaximaSaque) &&
        Objects.equals(this.taxaSaque, taxasRefinanciamento.taxaSaque) &&
        Objects.equals(this.taxaMaximaCompraJuros, taxasRefinanciamento.taxaMaximaCompraJuros) &&
        Objects.equals(this.taxaCompraJuros, taxasRefinanciamento.taxaCompraJuros) &&
        Objects.equals(this.taxaPermanencia, taxasRefinanciamento.taxaPermanencia) &&
        Objects.equals(this.taxaRefinanciamento, taxasRefinanciamento.taxaRefinanciamento) &&
        Objects.equals(this.taxaRecuperacaoRefinanciamento, taxasRefinanciamento.taxaRecuperacaoRefinanciamento) &&
        Objects.equals(this.taxaPercCalcPagamentoMinimo, taxasRefinanciamento.taxaPercCalcPagamentoMinimo) &&
        Objects.equals(this.planoTaxaDefault, taxasRefinanciamento.planoTaxaDefault);
  }

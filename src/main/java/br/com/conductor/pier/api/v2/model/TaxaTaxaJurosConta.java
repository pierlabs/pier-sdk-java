...
public class TaxaTaxaJurosConta   {
  ...
  @ApiModelProperty(example = "null", required = true, value = "Number of months of grace period")
  ...
  @ApiModelProperty(example = "null", required = true, value = "Interest rate value")

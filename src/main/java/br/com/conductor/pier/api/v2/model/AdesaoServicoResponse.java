...
public class AdesaoServicoResponse   {
   ...
   **/
  public AdesaoServicoResponse flagAdesaoCompraProgramada(Boolean flagAdesaoCompraProgramada) {
    this.flagAdesaoCompraProgramada = flagAdesaoCompraProgramada;
    return this;
  }
  
  @ApiModelProperty(example = "false", value = "Permite ades\u00E3o da compra programada")
   ...
   **/
  public AdesaoServicoResponse flagAdesaoInvestimento(Boolean flagAdesaoInvestimento) {
    this.flagAdesaoInvestimento = flagAdesaoInvestimento;
    return this;
  }
  
  @ApiModelProperty(example = "false", value = "Permite adesao do investimentos")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.canal, adesaoServicoResponse.canal) &&
        ...
        Objects.equals(this.flagAdesaoCompraProgramada, adesaoServicoResponse.flagAdesaoCompraProgramada) &&
        Objects.equals(this.flagAdesaoInvestimento, adesaoServicoResponse.flagAdesaoInvestimento) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(canal, cobrancaLimiteCredito, estabelecimento, flagAdesaoCompraProgramada, flagAdesaoInvestimento, flagCobrancaLimiteCredito, flagOfertasPromocoes, flagPromocoes, flagTipoEnvioFatura, flagTipoSms, id, responsavel, tipoEnvioFatura, tipoSms);
  }

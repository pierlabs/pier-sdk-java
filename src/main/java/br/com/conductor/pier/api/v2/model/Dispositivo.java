...
public class Dispositivo   {
   ...
   **/
  public Dispositivo token(String token) {
    this.token = token;
    return this;
  }
   ...
   **/
  public Dispositivo idAplicacaoMobile(Long idAplicacaoMobile) {
   ...
   **/
  public Dispositivo idUsuario(Long idUsuario) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, dispositivo.id) &&
        Objects.equals(this.token, dispositivo.token) &&
        Objects.equals(this.idAplicacaoMobile, dispositivo.idAplicacaoMobile) &&
        Objects.equals(this.idUsuario, dispositivo.idUsuario);
  }

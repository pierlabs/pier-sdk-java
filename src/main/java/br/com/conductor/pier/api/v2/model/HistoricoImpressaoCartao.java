...
public class HistoricoImpressaoCartao   {
   ...
   **/
  public HistoricoImpressaoCartao id(Long id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public HistoricoImpressaoCartao idCartao(Long idCartao) {
   ...
   **/
  public HistoricoImpressaoCartao idStatusImpressaoCartao(Long idStatusImpressaoCartao) {
   ...
   **/
  public HistoricoImpressaoCartao mensagemHistorico(String mensagemHistorico) {
   ...
   **/
  public HistoricoImpressaoCartao dataHistorico(String dataHistorico) {

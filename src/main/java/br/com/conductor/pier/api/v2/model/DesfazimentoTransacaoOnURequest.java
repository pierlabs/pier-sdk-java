...
public class DesfazimentoTransacaoOnURequest   {
   ...
   **/
  public DesfazimentoTransacaoOnURequest dataHoraTransacaoCancelada(String dataHoraTransacaoCancelada) {
   ...
   **/
  public DesfazimentoTransacaoOnURequest dataHoraTerminal(String dataHoraTerminal) {

...
public class FaturaConsolidadaResponse   {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(idConta, pagamentoEfetuado, dataVencimentoFatura, dataVencimentoReal, dataFechamento, valorTotal, valorPagamentoMinimo, saldoAnterior, idBoleto);
  }

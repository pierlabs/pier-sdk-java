...
public class TokenCartaoUpdate   {
   ...
   * Token
   **/
  public TokenCartaoUpdate token(String token) {
    this.token = token;
    return this;
  }
   ...
   **/
  public TokenCartaoUpdate requestorID(String requestorID) {
   ...
   **/
  public TokenCartaoUpdate referenceID(String referenceID) {
   ...
   **/
  public TokenCartaoUpdate panReferenceID(String panReferenceID) {
   ...
   * Tipo do token
   **/
  public TokenCartaoUpdate tipo(String tipo) {
    this.tipo = tipo;
    return this;
  }
   ...
   * Status do token
   **/
  public TokenCartaoUpdate status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   **/
  public TokenCartaoUpdate ultimoStatus(UltimoStatusEnum ultimoStatus) {
   ...
   * C\u00F3digo de ativa\u00E7\u00E3o
   **/
  public TokenCartaoUpdate codigoAtivacao(String codigoAtivacao) {
   ...
   **/
  public TokenCartaoUpdate tentativasAtivacao(Integer tentativasAtivacao) {
   ...
   **/
  public TokenCartaoUpdate qtdCodigosAtivacao(Integer qtdCodigosAtivacao) {
   ...
   * Score
   **/
  public TokenCartaoUpdate score(Integer score) {
    this.score = score;
    return this;
  }
   ...
   **/
  public TokenCartaoUpdate resultadoAprovisionamento(String resultadoAprovisionamento) {
   ...
   * Data de validade
   **/
  public TokenCartaoUpdate validade(String validade) {
   ...
   **/
  public TokenCartaoUpdate dataAtualizacaoChaveDispositivo(String dataAtualizacaoChaveDispositivo) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TokenCartaoUpdate tokenCartaoUpdate = (TokenCartaoUpdate) o;
    return Objects.equals(this.token, tokenCartaoUpdate.token) &&
        Objects.equals(this.requestorID, tokenCartaoUpdate.requestorID) &&
        Objects.equals(this.referenceID, tokenCartaoUpdate.referenceID) &&
        Objects.equals(this.panReferenceID, tokenCartaoUpdate.panReferenceID) &&
        Objects.equals(this.tipo, tokenCartaoUpdate.tipo) &&
        Objects.equals(this.status, tokenCartaoUpdate.status) &&
        Objects.equals(this.ultimoStatus, tokenCartaoUpdate.ultimoStatus) &&
        Objects.equals(this.codigoAtivacao, tokenCartaoUpdate.codigoAtivacao) &&
        Objects.equals(this.tentativasAtivacao, tokenCartaoUpdate.tentativasAtivacao) &&
        Objects.equals(this.qtdCodigosAtivacao, tokenCartaoUpdate.qtdCodigosAtivacao) &&
        Objects.equals(this.score, tokenCartaoUpdate.score) &&
        Objects.equals(this.resultadoAprovisionamento, tokenCartaoUpdate.resultadoAprovisionamento) &&
        Objects.equals(this.validade, tokenCartaoUpdate.validade) &&
        Objects.equals(this.dataAtualizacaoChaveDispositivo, tokenCartaoUpdate.dataAtualizacaoChaveDispositivo);
  }

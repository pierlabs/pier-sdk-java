...
public class OperacaoCredorUpdate   {
  ...
  @ApiModelProperty(example = "3", value = "Show the id of the product that will be updated")
  ...
  @ApiModelProperty(example = "AGENDA", value = "Multiplier Factor (OUR_SCHEDULE(0), SCHEDULE(1))")

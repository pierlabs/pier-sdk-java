...
public class NotificacaoPushResponse   {
  ...
  public enum TipoEventoEnum {
    ...
    TRANSACAO_ADVICE_NAO_AUTORIZADO("TRANSACAO_ADVICE_NAO_AUTORIZADO"),
    TRANSACAO_ERRO("TRANSACAO_ERRO"),
    TRANSACAO_ERRO_NAO_AUTORIZADO("TRANSACAO_ERRO_NAO_AUTORIZADO"),
    TRANSACAO_SIMULACAO("TRANSACAO_SIMULACAO"),
    TRANSACAO_SIMULACAO_NAO_AUTORIZADO("TRANSACAO_SIMULACAO_NAO_AUTORIZADO"),
    TRANSACAO_SENHA_CHIP("TRANSACAO_SENHA_CHIP"),
    TRANSACAO_SENHA_CHIP_NAO_AUTORIZADO("TRANSACAO_SENHA_CHIP_NAO_AUTORIZADO"),
    TRANSACAO_CONSULTA_SALDO("TRANSACAO_CONSULTA_SALDO"),
    TRANSACAO_CONSULTA_SALDO_NAO_AUTORIZADO("TRANSACAO_CONSULTA_SALDO_NAO_AUTORIZADO"),
    TRANSACAO_CONSULTA_STATUS_CONTA("TRANSACAO_CONSULTA_STATUS_CONTA"),
    TRANSACAO_CONSULTA_STATUS_CONTA_NAO_AUTORIZADO("TRANSACAO_CONSULTA_STATUS_CONTA_NAO_AUTORIZADO"),
    TRANSACAO_DESFAZIMENTO("TRANSACAO_DESFAZIMENTO"),
    TRANSACAO_DESFAZIMENTO_NAO_AUTORIZADO("TRANSACAO_DESFAZIMENTO_NAO_AUTORIZADO"),
    TRANSACAO_CANCELAMENTO("TRANSACAO_CANCELAMENTO"),
    TRANSACAO_CANCELAMENTO_NAO_AUTORIZADO("TRANSACAO_CANCELAMENTO_NAO_AUTORIZADO"),
    TRANSACAO_RESPOSTA_SONDA("TRANSACAO_RESPOSTA_SONDA"),
    TRANSACAO_RESPOSTA_SONDA_NAO_AUTORIZADO("TRANSACAO_RESPOSTA_SONDA_NAO_AUTORIZADO"),
    TRANSACAO_TOKEN("TRANSACAO_TOKEN"),
    TRANSACAO_TOKEN_NAO_AUTORIZADO("TRANSACAO_TOKEN_NAO_AUTORIZADO");
  ...
  @ApiModelProperty(example = "null", value = "Nome do tipoEvento da notifica\u00E7\u00E3o")
  ...
  @ApiModelProperty(example = "null", value = "Status de envio da notifica\u00E7\u00E3o")
  @JsonProperty("status")
  ...
  @ApiModelProperty(example = "null", required = true, value = "Token do dispositivo a qual foi destinado a notifica\u00E7\u00E3o (device_token)")
  ...
  @ApiModelProperty(example = "null", required = true, value = "T\u00EDtulo da notifica\u00E7\u00E3o enviada")
  @JsonProperty("titulo")
  ...
  @ApiModelProperty(example = "null", required = true, value = "Conte\u00FAdo da notifica\u00E7\u00E3o enviada")

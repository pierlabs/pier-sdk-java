...
public class LoteCartaoPersist   {
   ...
   **/
  public LoteCartaoPersist qtdSolicitada(Integer qtdSolicitada) {
    this.qtdSolicitada = qtdSolicitada;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "Quantidade de cart\u00F5es a ser emitido")
   ...
   **/
  public LoteCartaoPersist idProduto(Long idProduto) {
   ...
   **/
  public LoteCartaoPersist idSolicitante(Long idSolicitante) {
   ...
   **/
  public LoteCartaoPersist idOrigemComercial(Long idOrigemComercial) {
   ...
   **/
  public LoteCartaoPersist idPlastico(Long idPlastico) {
    this.idPlastico = idPlastico;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "C\u00F3digo identificador do tipo pl\u00E1stico associado ao produto")
   ...
   **/
  public LoteCartaoPersist idImagem(Long idImagem) {
    this.idImagem = idImagem;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "C\u00F3digo identificador do tipo pl\u00E1stico imagem")
   ...
   **/
  public LoteCartaoPersist idContaDefault(Long idContaDefault) {
   ...
   **/
  public LoteCartaoPersist flagMultiApp(Boolean flagMultiApp) {
    this.flagMultiApp = flagMultiApp;
    return this;
  }
  
  @ApiModelProperty(example = "false", required = true, value = "Indica se o lote ser\u00E1 de cart\u00F5es m\u00FAltiplos")
   ...
   **/
  public LoteCartaoPersist dataAgendamento(String dataAgendamento) {
    this.dataAgendamento = dataAgendamento;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "Data de agendamento da execu\u00E7\u00E3o do lote")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    LoteCartaoPersist loteCartaoPersist = (LoteCartaoPersist) o;
    return Objects.equals(this.qtdSolicitada, loteCartaoPersist.qtdSolicitada) &&
        Objects.equals(this.idProduto, loteCartaoPersist.idProduto) &&
        Objects.equals(this.idSolicitante, loteCartaoPersist.idSolicitante) &&
        Objects.equals(this.idOrigemComercial, loteCartaoPersist.idOrigemComercial) &&
        Objects.equals(this.idPlastico, loteCartaoPersist.idPlastico) &&
        Objects.equals(this.idImagem, loteCartaoPersist.idImagem) &&
        Objects.equals(this.idContaDefault, loteCartaoPersist.idContaDefault) &&
        Objects.equals(this.flagMultiApp, loteCartaoPersist.flagMultiApp) &&
        Objects.equals(this.dataAgendamento, loteCartaoPersist.dataAgendamento);
  }

...
public class WebhookPersist   {
   ...
   **/
  public WebhookPersist tipoEvento(TipoEventoEnum tipoEvento) {
   ...
   **/
  public WebhookPersist url(String url) {
    this.url = url;
    return this;
  }
  
  @ApiModelProperty(example = "null", required = true, value = "Url a ser consumida pelo WebHook")
  @JsonProperty("url")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WebhookPersist webhookPersist = (WebhookPersist) o;
    return Objects.equals(this.tipoEvento, webhookPersist.tipoEvento) &&
        Objects.equals(this.url, webhookPersist.url);
  }

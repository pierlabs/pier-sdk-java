...
public class BasePartialUpdateValue   {
   ...
   **/
  public BasePartialUpdateValue servidor(String servidor) {
    this.servidor = servidor;
    return this;
  }
  
  @ApiModelProperty(example = "abc-xyz-99.exemplo.com", required = true, value = "{{{base_partial_update_servidor_value}}}")
   ...
   **/
  public BasePartialUpdateValue usuario(String usuario) {
    this.usuario = usuario;
    return this;
  }
  
  @ApiModelProperty(example = "pier", required = true, value = "{{{base_partial_update_usuario_value}}}")
   ...
   **/
  public BasePartialUpdateValue senha(String senha) {
    this.senha = senha;
    return this;
  }
  
  @ApiModelProperty(example = "abcd1234", required = true, value = "{{{base_partial_update_senha_value}}}")
  @JsonProperty("senha")
   ...
   **/
  public BasePartialUpdateValue nomeBase(String nomeBase) {
    this.nomeBase = nomeBase;
    return this;
  }
  
  @ApiModelProperty(example = "emissor", required = true, value = "{{{base_partial_update_nome_base_value}}}")
   ...
   **/
  public BasePartialUpdateValue alteradoPor(String alteradoPor) {
    this.alteradoPor = alteradoPor;
    return this;
  }
  
  @ApiModelProperty(example = "beltrano.detal", required = true, value = "{{{base_partial_update_alterado_por_value}}}")
   ...
   **/
  public BasePartialUpdateValue domain(String domain) {
    this.domain = domain;
    return this;
  }
  
  @ApiModelProperty(example = "dominio", value = "{{{base_partial_update_domain_value}}}")
  @JsonProperty("domain")
   ...
   **/
  public BasePartialUpdateValue senhaCriptografada(Boolean senhaCriptografada) {
    this.senhaCriptografada = senhaCriptografada;
    return this;
  }
  
  @ApiModelProperty(example = "true", required = true, value = "{{{base_partial_update_senha_criptografada_value}}}")
   ...
   **/
  public BasePartialUpdateValue nomeBaseControleAcesso(String nomeBaseControleAcesso) {
    this.nomeBaseControleAcesso = nomeBaseControleAcesso;
    return this;
  }
  
  @ApiModelProperty(example = "AccessControl_Novo_Des", required = true, value = "{{{base_partial_update_nome_base_controle_acesso_value}}}")
   ...
   **/
  public BasePartialUpdateValue idEmissor(Long idEmissor) {
    this.idEmissor = idEmissor;
    return this;
  }
  
  @ApiModelProperty(example = "99", value = "{{{base_partial_update_id_emissor_value}}}")
   ...
   **/
  public BasePartialUpdateValue servidorControleAcesso(String servidorControleAcesso) {
    this.servidorControleAcesso = servidorControleAcesso;
    return this;
  }
  
  @ApiModelProperty(example = "10.10.10.10", required = true, value = "{{{base_partial_update_servidor_controle_acesso_value}}}")
   ...
   **/
  public BasePartialUpdateValue nomeBaseUsuarios(String nomeBaseUsuarios) {
    this.nomeBaseUsuarios = nomeBaseUsuarios;
    return this;
  }
  
  @ApiModelProperty(example = "USUARIOS_EMISSOR", required = true, value = "{{{base_partial_update_nome_base_usuarios_value}}}")
   ...
   **/
  public BasePartialUpdateValue servidorUsuarios(String servidorUsuarios) {
    this.servidorUsuarios = servidorUsuarios;
    return this;
  }
  
  @ApiModelProperty(example = "10.10.10.10", required = true, value = "{{{base_partial_update_servidor_usuarios_value}}}")
   ...
   **/
  public BasePartialUpdateValue flagCluster(Boolean flagCluster) {
    this.flagCluster = flagCluster;
    return this;
  }
  
  @ApiModelProperty(example = "false", required = true, value = "{{{base_partial_update_flag_cluster_value}}}")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BasePartialUpdateValue basePartialUpdateValue = (BasePartialUpdateValue) o;
    return Objects.equals(this.servidor, basePartialUpdateValue.servidor) &&
        Objects.equals(this.usuario, basePartialUpdateValue.usuario) &&
        Objects.equals(this.senha, basePartialUpdateValue.senha) &&
        Objects.equals(this.nomeBase, basePartialUpdateValue.nomeBase) &&
        Objects.equals(this.alteradoPor, basePartialUpdateValue.alteradoPor) &&
        Objects.equals(this.domain, basePartialUpdateValue.domain) &&
        Objects.equals(this.senhaCriptografada, basePartialUpdateValue.senhaCriptografada) &&
        Objects.equals(this.nomeBaseControleAcesso, basePartialUpdateValue.nomeBaseControleAcesso) &&
        Objects.equals(this.idEmissor, basePartialUpdateValue.idEmissor) &&
        Objects.equals(this.servidorControleAcesso, basePartialUpdateValue.servidorControleAcesso) &&
        Objects.equals(this.nomeBaseUsuarios, basePartialUpdateValue.nomeBaseUsuarios) &&
        Objects.equals(this.servidorUsuarios, basePartialUpdateValue.servidorUsuarios) &&
        Objects.equals(this.flagCluster, basePartialUpdateValue.flagCluster);
  }

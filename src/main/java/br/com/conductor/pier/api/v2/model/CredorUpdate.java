...
public class CredorUpdate   {
  ...
  @ApiModelProperty(example = "null", value = "Telefones de contato do escrit\u00F3rio de cobran\u00E7a")
  ...
  @ApiModelProperty(example = "null", required = true, value = "Taxa administrativa usada para gerar o valor do RAV")
